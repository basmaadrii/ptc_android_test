...
class ProductFragment : Fragment() {
    ...
    private fun updateView(product: android.ptc.com.ptcflixing.data.model.ProductDetails) {
        binding.fragmentProductProgressBar.isVisible = false
    ...
    private fun showImages(images: List<android.ptc.com.ptcflixing.data.model.Image>) {
